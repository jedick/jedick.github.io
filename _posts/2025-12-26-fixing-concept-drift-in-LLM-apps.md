...
classes: wide
header:
  teaser: /assets/images/2025-12-26-fixing-concept-drift-in-LLM-apps/concept-drift.jpg
  header: /assets/images/2025-12-26-fixing-concept-drift-in-LLM-apps/concept-drift.jpg
  og_image: /assets/images/2025-12-26-fixing-concept-drift-in-LLM-apps/concept-drift.jpg
---
...
<figure style="width: 75%">
  <img src="/assets/images/2025-12-26-fixing-concept-drift-in-LLM-apps/concept-drift.jpg" alt="Concept drift and feedback loop optimization">
  <figcaption>
    <a href="https://chatgpt.com/share/694df3c0-a804-800b-b8f4-700d3d2ce7a9">Generated with ChatGPT</a>
  </figcaption>
</figure>
...
<figure style="width: 75%">
  <img src="/assets/images/2025-12-26-fixing-concept-drift-in-LLM-apps/eval-accuracy.png" alt="Plots of concept drift and model accuracy">
  <figcaption>
...
> To make feedback collection easier the app has a "🎲 Special Random" button that classifies random pages until a hard example is found.
> Try it out!
...
Iteratively refining prompts with accumulated user feedback isn't just good practice—it's
...
- Design prompts to be updatable—treat them as living components, not frozen artifacts
- Monitor both input distributions and output quality over time
- Plan for continuous alignment as a production process, not a one-time development task
...
Feedback data is publicly available in this 🤗 [Hugging Face Dataset].
