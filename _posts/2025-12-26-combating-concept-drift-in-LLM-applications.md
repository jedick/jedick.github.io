...
> For easier feedback collection the app has a "🎲 Special Random" button that classifies random pages until a hard example is found.
> Try it out!
...
The live app is deployed on 🤗 [Hugging Face Spaces].
